...
const AddressModal = ({ setShowAddressModal }) => {
    ...
    const modalContent = (
        <form onSubmit={e => toast.promise(handleSubmit(e), { loading: 'Adding Address...' })} className="fixed inset-0 bg-white/60 backdrop-blur h-screen flex items-center justify-center" style={{ zIndex: 9999 }}>
